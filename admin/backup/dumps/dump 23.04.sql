...
-- Started on 2024-04-23 11:22:55
...
-- Name: ajoutequipement(text, text, integer, text, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ajoutequipement(text, text, integer, text, integer, integer) RETURNS integer
    LANGUAGE plpgsql
    AS $_$
...
begin
 select into id id_equipement from equipement where nom = p_nom;
 if not found
 then
...
--
-- TOC entry 228 (class 1255 OID 16690)
...
--
-- TOC entry 4716 (class 2604 OID 16623)
...
--
-- TOC entry 4717 (class 2604 OID 16659)
...
--
-- TOC entry 4714 (class 2604 OID 16591)
...
--
-- TOC entry 4713 (class 2604 OID 16580)
...
--
-- TOC entry 4715 (class 2604 OID 16604)
...
--
-- TOC entry 4892 (class 0 OID 16620)
-- Dependencies: 222
...
--
-- TOC entry 4894 (class 0 OID 16656)
-- Dependencies: 224
...
--
-- TOC entry 4888 (class 0 OID 16588)
-- Dependencies: 218
...
--
-- TOC entry 4886 (class 0 OID 16577)
-- Dependencies: 216
...
--
-- TOC entry 4890 (class 0 OID 16601)
-- Dependencies: 220
...
--
-- TOC entry 4731 (class 2606 OID 16629)
...
--
-- TOC entry 4735 (class 2606 OID 16663)
...
--
-- TOC entry 4723 (class 2606 OID 16597)
...
--
-- TOC entry 4725 (class 2606 OID 16599)
...
--
-- TOC entry 4719 (class 2606 OID 16586)
...
--
-- TOC entry 4721 (class 2606 OID 16584)
...
--
-- TOC entry 4729 (class 2606 OID 16608)
...
--
-- TOC entry 4741 (class 2620 OID 16646)
...
--
-- TOC entry 4738 (class 2606 OID 16669)
...
--
-- TOC entry 4739 (class 2606 OID 16614)
...
--
-- TOC entry 4740 (class 2606 OID 16609)
...
-- Completed on 2024-04-23 11:22:55
